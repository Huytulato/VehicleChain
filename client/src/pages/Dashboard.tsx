        ...
        <div className="transition-all duration-300 ease-in-out">
          {activeTab === 'garage' && (
            <div className="animate-fade-in">
              <MyGarage onRegisterClick={() => setShowRegisterForm(true)} />
            </div>
          )}
          {activeTab === 'search' && (
            <div className="animate-fade-in">
              <div className="bg-white rounded-xl shadow-lg p-12 text-center">
                <div className="max-w-md mx-auto">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="w-full px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition-all">
                      Tìm kiếm
                    </button>
                  </div>
                  ...
                  <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <p className="text-sm text-blue-800">
                      <strong>Gợi ý:</strong> Nhập số VIN hoặc biển số để xem lịch sử đầy đủ của phương tiện trên blockchain
                    </p>
                  </div>
                </div>
              </div>
